...
```{r ustawienia, echo=FALSE, results='hide', message=FALSE}
library(corrplot)
library(dplyr)
library(ggplot2)
library(plotly)
...
# TODO make it better, too much empty space between
```
...
Dzięki tej linii na wykresie można z łatwością zaobserować, że do około 15000 przykładu rozmiar śledzia rósł, a później zaczął stopniowo spadać, aż osiągnął średnie minimum w ostatnim przykładzie.