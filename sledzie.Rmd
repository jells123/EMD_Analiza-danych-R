...
Aby uzyskać model lepiej dopasowujący się do danych zbudowałyśmy model regresji wielomianowej poprzez proste dodanie istniejących zmiennych podniesionych do potęgi do modelu. Zabieg ten spowodował znaczny spadek błędu średniokwadratowego a zatem lepsze dopasowanie, był jednak opisany dość specyficznym równaniem z punktu widzenia interpretacji.

Jednak wynik udało się poprawić jeszcze bardziej, korzystając z modelu z rodziny *ensemble methods* - Gradient Boosting Machine - złożonego z drzew decyzyjnych. Okazał się on być najlepszy z pośród przez nas przetestowanych i zapewnił nam wynik RMSE równy 1.13 (centymetra) oraz R-squared równe 0.52.
...
Jak można zauważyć, najmniejszą wartość $RMSE$ oraz najlepsze dopasowanie $R-squared$ uzyskane zostało dla współczynnika $\alpha=0.4$.
